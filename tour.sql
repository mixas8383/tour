...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2016 at 10:46 PM
...
--
-- Table structure for table `cz2qa_assets`
--

CREATE TABLE IF NOT EXISTS `cz2qa_assets` (
...
--
-- Dumping data for table `cz2qa_assets`
--

INSERT INTO `cz2qa_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `cz2qa_associations`
--

CREATE TABLE IF NOT EXISTS `cz2qa_associations` (
...
--
-- Table structure for table `cz2qa_banners`
--

CREATE TABLE IF NOT EXISTS `cz2qa_banners` (
...
--
-- Table structure for table `cz2qa_banner_clients`
--

CREATE TABLE IF NOT EXISTS `cz2qa_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `cz2qa_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `cz2qa_banner_tracks` (
...
--
-- Table structure for table `cz2qa_categories`
--

CREATE TABLE IF NOT EXISTS `cz2qa_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cz2qa_categories`
--

INSERT INTO `cz2qa_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 643, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 643, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 643, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 643, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 643, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 643, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_contact_details`
--

CREATE TABLE IF NOT EXISTS `cz2qa_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `cz2qa_content`
--

CREATE TABLE IF NOT EXISTS `cz2qa_content` (
...
--
-- Table structure for table `cz2qa_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `cz2qa_contentitem_tag_map` (
...
--
-- Table structure for table `cz2qa_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `cz2qa_content_frontpage` (
...
--
-- Table structure for table `cz2qa_content_rating`
--

CREATE TABLE IF NOT EXISTS `cz2qa_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cz2qa_content_types`
--

CREATE TABLE IF NOT EXISTS `cz2qa_content_types` (
...
--
-- Dumping data for table `cz2qa_content_types`
--

INSERT INTO `cz2qa_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `cz2qa_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `cz2qa_core_log_searches` (
...
--
-- Table structure for table `cz2qa_extensions`
--

CREATE TABLE IF NOT EXISTS `cz2qa_extensions` (
...
--
-- Dumping data for table `cz2qa_extensions`
--

INSERT INTO `cz2qa_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"b94a950f45db81aed73428219b895e33"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1481826424}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":1481826488,"unique_id":"fd8ec810ffb7fb6eafdfe780009bd91b1e26c46c","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'design_control', 'template', 'design_control', '', 0, 1, 1, 0, '{"name":"design_control","type":"template","creationDate":"December 2014","author":"Shape5.com","copyright":"Shape5","authorEmail":"contact@shape5.com","authorUrl":"http:\\/\\/www.shape5.com","version":"1.0","description":"\\n\\t\\n\\t<h1>Shape 5 - Design Control<\\/h1>\\n\\n\\t<br\\/>\\n\\t<img src=\\"..\\/templates\\/design_control\\/template_thumbnail.png\\" align=\\"left\\" hspace=\\"10\\" style=\\"padding-right:10px;\\"\\/>\\n\\tThis template is a free GPL licensed template Please be sure to visit our site for other great products.  <br \\/><br \\/>\\n\\tFor tutorials pertaining to this template and additional information check out:<br \\/> <a href=\\"http:\\/\\/www.shape5.com\\/demo\\/design_control\\">Design Control Demo<\\/a>\\n\\t<br \\/>\\n\\t<a href=\\"http:\\/\\/www.shape5.com\\/joomla_tutorials.html\\">Joomla and Vertex Tutorials<\\/a>\\n\\t<br \\/>\\n\\t<br \\/><a target=\\"_blank\\" href=\\"http:\\/\\/www.shape5.com\\">Click here<\\/a> to visit Shape5.com\\n\\t<br \\/><br \\/>\\n\\t<div class=\\"vertex-admin-logoback\\"><div class=\\"vertex-admin-logo\\"><\\/div><\\/div>\\n\\t<br \\/><br \\/>\\n\\tPowered by a comprehensive template blue print<br\\/><br\\/>\\n\\t<a target=\\"_blank\\" href=\\"http:\\/\\/www.shape5.com\\/joomla\\/framework\\/vertex_framework.html\\">Read more about Vertex here<\\/a> \\n\\t\\n\\t\\n\\t\\n\\t","group":"","filename":"templateDetails"}', '{"settings":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'AS 002066 Free', 'template', 'as002066free', '', 0, 1, 1, 0, '{"name":"AS 002066 Free","type":"template","creationDate":"2014-03-25","author":"AS Designing","copyright":"AS Designing","authorEmail":"","authorUrl":"http:\\/\\/www.asdesigning.com","version":"2.0.0","description":"\\n\\t\\n\\t\\n\\t\\t\\t<img src=\\"..\\/templates\\/as002066free\\/template_thumbnail.png\\" align=\\"left\\" class=\\"template_thumbnail\\" \\n\\t\\t\\t\\t\\tstyle=\\"margin: 0px 30px 10px 0px; display: none;\\" \\/>\\n\\t\\t\\t\\t\\t\\n\\t\\t\\t<h1><span  style=\\"padding-top: 5px; display: block\\">AS Template 002066 Free Version for Joomla! 3<\\/span><\\/h1>\\n\\t\\t\\t\\n\\t\\t\\t<br \\/><a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-documentation\\/238-002066\\" target=\\"_blank\\">Click here<\\/a>  to see the template documentation.\\n\\t\\t\\t<br \\/>Visit our site for more templates: <a href=\\"http:\\/\\/www.astemplates.com\\" target=\\"_blank\\">http:\\/\\/www.astemplates.com<\\/a>\\n\\t\\t\\t<br \\/>\\n\\t\\t\\t\\n\\t\\t\\t<span style=\\"color:orange; font-size:16px \\">\\n\\t\\t\\tFree Version is limited and may not include all configuration parameters and module positions.<br \\/><br \\/>\\n\\t\\t\\t<\\/span>\\n\\t\\t\\t \\n\\t\\t\\t<a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/21-002018\\" target=\\"_blank\\">\\n\\t\\t\\t<b style=\\"color:red;  font-size:18px\\">DOWNLOAD full free package from here:<\\/b><\\/a><br \\/>\\n\\t\\t\\t<a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/21-002018\\" target=\\"_blank\\">http:\\/\\/www.astemplates.com\\/joomla-template-details\\/21-002018<\\/a>\\n\\t\\t\\t<br \\/><br \\/><br \\/><br \\/>\\n\\t\\t\\t<hr \\/>\\n\\t\\t\\t\\n\\t\\t\\t<h3><b>Popular AS Templates:<\\/b><\\/h3><br \\/>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/436-002085\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/436\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/219-002060\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/219\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/545-002096\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/545\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/516-002095\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/516\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/545-002096\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/545\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a><br \\/><br \\/>\\n\\t\\t\\t\\t\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/212-002057\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/212\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/228-002063\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/228\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/218-002059\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/218\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/458-002091\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/458\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\n\\t\\t\\t    <a href=\\"http:\\/\\/www.astemplates.com\\/joomla-template-details\\/445-002090\\" target=\\"_blank\\" style=\\"margin: 10px 20px 20px 0px;\\">\\n\\t\\t\\t\\t<img src=\\"http:\\/\\/www.astemplates.com\\/content\\/templates\\/445\\/template.thumbnail.png\\">\\n\\t\\t\\t\\t<\\/a>\\t\\t\\t\\t\\n\\t\\t\\t<br \\/><br \\/>\\n\\t","group":"","filename":"templateDetails"}', '{"body_font_family":"PT Sans","body_font_size":"14","body_font_color":"","hfont_family":"PT Sans","h1_font_size":"","h2_font_size":"","h3_font_size":"","h4_font_size":"","h5_font_size":"","logo_size":"12","logo_type":"1","logo_img":"","logo_txt":"","logo_font_family":"PT Sans","logo_font_size":"","logo_font_style":"normal","logo_font_weight":"normal","logo_font_color":"","slogan_txt":"","slogan_font_family":"PT Sans","slogan_font_size":"12","slogan_font_style":"normal","slogan_font_weight":"normal","slogan_font_color":"","aside_left_width":"4","aside_right_width":"4","feature_responsive":"1","feature_totop":"1","feature_totop_text":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'wt_clean_free', 'template', 'wt_clean_free', '', 0, 1, 1, 0, '{"name":"wt_clean_free","type":"template","creationDate":"June 2015","author":"WARPtheme","copyright":"Copyright (C) Warptheme","authorEmail":"support@warptheme.com","authorUrl":"http:\\/\\/www.warptheme.com","version":"1.0.7","description":"\\n\\t\\n\\t\\t<div class=\\"overview-header\\" style=\\"text-align: left;\\">\\n\\t\\t\\t<h2>\\n\\t\\t\\t  <small style=\\"display: block;\\">Responsive Business Joomla Template - <strong>WT Clean<\\/strong>.<\\/small><\\/h2>\\n\\t\\t\\t<p>WT Clean is a business and corporate template. Its simple and clean HTML5 & CSS3 Template. Its a full responsive template built Uikit & Warp Framework. The template is designed so it is easy to use and working on your site right on install.<\\/p>\\n\\t\\t\\t<p>Help and Support: Visit <a href=\\"http:\\/\\/warptheme.com\\/\\" target=\\"_blank\\">WarpTheme<\\/a><\\/p>\\n\\t\\t\\t<\\/div>\\n\\t\\t","group":"","filename":"templateDetails"}', '{"config":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 'ol_fipes', 'template', 'ol_fipes', '', 0, 1, 1, 0, '{"name":"ol_fipes","type":"template","creationDate":"2016","author":"olwebdesign.com","copyright":"Copyright (C) 2010 - 2016 olwebdesign.com. All rights reserved.","authorEmail":"support@olwebdesign.com","authorUrl":"http:\\/\\/www.olwebdesign.com","version":"3.5.0","description":"\\n\\t\\t\\t<style type=\\"text\\/css\\" media=\\"all\\">\\n\\t\\t\\t\\t<!--\\n\\t\\t\\t\\t#wrap1 {padding:0px 0px 4px 0px;}\\n\\t\\t\\t\\th1 {clear:both;font-family: Georgia, sans-serif;font-size:36px;margin:30px 20px 0px ;padding:0px 0px 14px 10px;color:#369; border-bottom: 1px solid #ccc; font-weight: normal;}\\n\\t\\t\\t\\th4 { border: none;  margin: 0 0 12px; padding:0; font: 20px\\/32px Georgia, sans-serif; color: #333; }\\t\\t\\t\\t\\n\\t\\t\\t\\t.wrap2 {background:#fff;padding: 20px; font-family: Arial; font-size:13px; text-align: justify; color: #4d4d4d; line-height: 24px;}\\n\\t\\t\\t\\t.leftside {margin: 16px 0 0 176px; font-weight:normal!important; }\\n\\t\\t\\t\\t.livedemo { margin-top: 28px; }\\n\\t\\t\\t\\t.param_headings {display:block; font-weight:bold; text-transform:uppercase; font-size:100%; background:#900; color:#fff;padding:5px 15px;}\\n\\t\\t\\t\\t.adminformlist .hasTip {cursor: help;}\\n\\t\\t\\t\\t.panel .title { padding: 9px !important; background: #fafafa !important;}\\n\\t\\t\\t\\t.panel .title:hover, .panel .title:active { padding: 9px !important; background: #f7f7f7 !important; }\\n\\t\\t\\t\\tul.adminformlist li { float: left; margin: 0px; padding: 5px 0 5px 0 !important; width: 100%; clear: left; }\\n\\t\\t\\t\\t#style-form .nav-tabs{border-bottom:2px solid #c00;}\\n\\t\\t\\t\\t#style-form .nav-tabs li a{font-size:16px;font-weight:400;line-height:20px; color: #000;outline:none; border-color:#cacaca; padding:10px 20px 9px; background:#f5f5f5;}\\n\\t\\t\\t\\t#style-form .nav-tabs > li > a:hover{background:#f1f1f1; color:#c00; border-color:#ccc; padding:10px 20px 9px;}\\n\\t\\t\\t\\t#style-form .nav-tabs li.active a{background:#c00; color:#fff; border-color:#c00; padding:10px 20px;}\\n\\t\\t\\t\\t* html .clearfix,:first-child+html .clearfix{zoom:1}\\n\\t\\t\\t\\t.line_separator.hasText{color:#f1f1f1;cursor:pointer;font-size:12px;line-height:1px;}\\n\\t\\t\\t\\t.line_separator{background:#ccc;clear:both;display:block;height:2px;margin:2px 0}\\n\\t\\t\\t\\t.line_separator.hasText span{background:#888;padding:4px 15px}\\n\\t\\t\\t\\t.text-limit{text-align:right}\\n\\t\\t\\t\\t-->\\n\\t\\t\\t<\\/style>\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t<div id=\\"wrap1\\">     \\n\\t\\t\\t<h1><em>ol_fipes free<\\/em><\\/h1>\\n\\t\\t\\t<div class=\\"wrap2\\">                  \\t\\t\\t\\t\\t\\t\\n\\t\\t\\t<a title=\\"Visit the official website!\\" href=\\"http:\\/\\/www.olwebdesign.com\\/\\" target=\\"_blank\\"> <img style=\\"float:left;border:1px solid #ccc;margin-right:10px;padding:3px\\" src=\\"..\\/templates\\/ol_fipes\\/template_thumbnail.png\\" border=\\"0\\" alt=\\"Logo\\" \\/><\\/a>   \\n\\t\\t\\t<div class=\\"leftside\\">\\n\\t\\t\\t<h4>Free Joomla Template.<\\/h4> \\n\\t\\t\\t<p>Some features are not available in free version. <br\\/>\\n\\t\\t\\tPro template which has all features, the extension, demo sql installer and template help are included on the full package. For additional information visit <a href=\\"http:\\/\\/www.olwebdesign.com\\/professional-joomla-templates-showcase\\/item\\/120-ol-doodi-responsive-joomla-template\\">olwebdesign<\\/a><\\/p>\\n\\t\\t\\t<\\/div><\\/div><\\/div>\\n","group":"","filename":"templateDetails"}', '{"logo_type":"image","showMediaLogo":"imglogo","logo_text":"SITE NAME","logo_slogan":"","logo_width":"180","logo_height":"65","hide_slider":"0","show_slider_items":"0","jukenburn_thumb1":"","jukenburn_texts1":"","jukenburn_desc1":"","jukenburn_info1":"","jukenburn_text1":"","jukenburn_thumb2":"","jukenburn_texts2":"","jukenburn_desc2":"","jukenburn_info2":"","jukenburn_text2":"","jukenburn_thumb3":"","jukenburn_texts3":"","jukenburn_desc3":"","jukenburn_info3":"","jukenburn_text3":"","jukenburn_thumb4":"","jukenburn_texts4":"","jukenburn_desc4":"","jukenburn_info4":"","jukenburn_text4":"","jukenburn_thumb5":"","jukenburn_texts5":"","jukenburn_desc5":"","jukenburn_info5":"","jukenburn_text5":"","headHeigh":"600","fullheight":"0","bannerTime":"1","banner":"on","menu":"bullet","styles":"round","shadow":"1","speed":"7000","social_api_type":"1","popup_fb":"1","popup_twitter":"1","popup_gplus":"1","popup_pinterest":"1","popup_linkedin":"0","popup_digg":"0","popup_vk":"0","popup_stumbleupon":"0","layout_type":"1","main_width":"960px","left_width":"25","right_width":"27","sideleft_width":"20","sideright_width":"30","width_unit":"percent","fixed_column_height":"0","float":"1","show_menu":"1","menutype":"mainmenu","mxmenu":"moo","menu_col_width":"200","show_menu_image":"1","menu_animation":"none","menu_duration":"300","menu_transition":"linear","init_x":"0","init_y":"0","sub_x":"0","sub_y":"0","tempcolor":"0","style":"green","BgColor":"","BgText":"","BgImage":"","BgPattern":"","HdText":"","HdColor":"","BtText":"","BtColor":"","MbColor":"","MbText":"","MbPattern":"","main_font":"13px","font_h1":"44px","font_h2":"33px","font_h3":"24px","go_respo":"0","cache_time":"60","direction":"ltr","compress_css":"0","compress_js":"0","enable_ga":"0","ga_code":"","showcp":"1","copyright":"2016 olwebdesign. All Rights Reserved.","designed_by":"1","copanel":"Top Panel","showtop":"0","show_awesome":"1","ie6warn":"1","jquery":"0","bootstrap":"1","hide_component":"0","hide_menu_items":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_finder_filters`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_filters` (
...
--
-- Table structure for table `cz2qa_finder_links`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links` (
...
--
-- Table structure for table `cz2qa_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms0` (
...
--
-- Table structure for table `cz2qa_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cz2qa_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `cz2qa_finder_taxonomy`
--

INSERT INTO `cz2qa_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `cz2qa_finder_terms`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_terms` (
...
--
-- Table structure for table `cz2qa_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `cz2qa_finder_terms_common`
--

INSERT INTO `cz2qa_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `cz2qa_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cz2qa_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `cz2qa_finder_types`
--

CREATE TABLE IF NOT EXISTS `cz2qa_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `cz2qa_languages`
--

CREATE TABLE IF NOT EXISTS `cz2qa_languages` (
...
--
-- Dumping data for table `cz2qa_languages`
--

INSERT INTO `cz2qa_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_menu`
--

CREATE TABLE IF NOT EXISTS `cz2qa_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cz2qa_menu`
--

INSERT INTO `cz2qa_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `cz2qa_menu_types`
--

CREATE TABLE IF NOT EXISTS `cz2qa_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cz2qa_menu_types`
--

INSERT INTO `cz2qa_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_messages`
--

CREATE TABLE IF NOT EXISTS `cz2qa_messages` (
...
--
-- Table structure for table `cz2qa_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `cz2qa_messages_cfg` (
...
--
-- Table structure for table `cz2qa_modules`
--

CREATE TABLE IF NOT EXISTS `cz2qa_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `cz2qa_modules`
--

INSERT INTO `cz2qa_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `cz2qa_modules_menu`
--

CREATE TABLE IF NOT EXISTS `cz2qa_modules_menu` (
...
--
-- Dumping data for table `cz2qa_modules_menu`
--

INSERT INTO `cz2qa_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `cz2qa_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `cz2qa_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `cz2qa_overrider`
--

CREATE TABLE IF NOT EXISTS `cz2qa_overrider` (
...
--
-- Table structure for table `cz2qa_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `cz2qa_postinstall_messages` (
...
--
-- Dumping data for table `cz2qa_postinstall_messages`
--

INSERT INTO `cz2qa_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `cz2qa_redirect_links`
--

CREATE TABLE IF NOT EXISTS `cz2qa_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `cz2qa_schemas`
--

CREATE TABLE IF NOT EXISTS `cz2qa_schemas` (
...
--
-- Dumping data for table `cz2qa_schemas`
--

INSERT INTO `cz2qa_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.3-2016-08-16');

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_session`
--

CREATE TABLE IF NOT EXISTS `cz2qa_session` (
...
--
-- Dumping data for table `cz2qa_session`
--

INSERT INTO `cz2qa_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('3fur1t4r5i6df156p687gp1l45', 0, 1, '1481827436', 'joomla|s:712:"";', 0, ''),
('h933oum87jl3nbe0mo635k8hm4', 1, 0, '1481827492', 'joomla|s:1128:"";', 643, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_tags`
--

CREATE TABLE IF NOT EXISTS `cz2qa_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `cz2qa_tags`
--

INSERT INTO `cz2qa_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 643, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_template_styles`
--

CREATE TABLE IF NOT EXISTS `cz2qa_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cz2qa_template_styles`
--

INSERT INTO `cz2qa_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'design_control', 0, '1', 'design_control - Default', '{"settings":""}'),
(10, 'as002066free', 0, '0', 'AS 002066 Free - Default', '{"body_font_family":"PT Sans","body_font_size":"14","body_font_color":"","hfont_family":"PT Sans","h1_font_size":"","h2_font_size":"","h3_font_size":"","h4_font_size":"","h5_font_size":"","logo_size":"12","logo_type":"1","logo_img":"","logo_txt":"","logo_font_family":"PT Sans","logo_font_size":"","logo_font_style":"normal","logo_font_weight":"normal","logo_font_color":"","slogan_txt":"","slogan_font_family":"PT Sans","slogan_font_size":"12","slogan_font_style":"normal","slogan_font_weight":"normal","slogan_font_color":"","aside_left_width":"4","aside_right_width":"4","feature_responsive":"1","feature_totop":"1","feature_totop_text":""}'),
(11, 'wt_clean_free', 0, '0', 'wt_clean_free - Default', '{"config":""}'),
(12, 'ol_fipes', 0, '0', 'ol_fipes - Default', '{"logo_type":"image","showMediaLogo":"imglogo","logo_text":"SITE NAME","logo_slogan":"","logo_width":"180","logo_height":"65","hide_slider":"0","show_slider_items":"0","jukenburn_thumb1":"","jukenburn_texts1":"","jukenburn_desc1":"","jukenburn_info1":"","jukenburn_text1":"","jukenburn_thumb2":"","jukenburn_texts2":"","jukenburn_desc2":"","jukenburn_info2":"","jukenburn_text2":"","jukenburn_thumb3":"","jukenburn_texts3":"","jukenburn_desc3":"","jukenburn_info3":"","jukenburn_text3":"","jukenburn_thumb4":"","jukenburn_texts4":"","jukenburn_desc4":"","jukenburn_info4":"","jukenburn_text4":"","jukenburn_thumb5":"","jukenburn_texts5":"","jukenburn_desc5":"","jukenburn_info5":"","jukenburn_text5":"","headHeigh":"600","fullheight":"0","bannerTime":"1","banner":"on","menu":"bullet","styles":"round","shadow":"1","speed":"7000","social_api_type":"1","popup_fb":"1","popup_twitter":"1","popup_gplus":"1","popup_pinterest":"1","popup_linkedin":"0","popup_digg":"0","popup_vk":"0","popup_stumbleupon":"0","layout_type":"1","main_width":"960px","left_width":"25","right_width":"27","sideleft_width":"20","sideright_width":"30","width_unit":"percent","fixed_column_height":"0","float":"1","show_menu":"1","menutype":"mainmenu","mxmenu":"moo","menu_col_width":"200","show_menu_image":"1","menu_animation":"none","menu_duration":"300","menu_transition":"linear","init_x":"0","init_y":"0","sub_x":"0","sub_y":"0","tempcolor":"0","style":"green","BgColor":"","BgText":"","BgImage":"","BgPattern":"","HdText":"","HdColor":"","BtText":"","BtColor":"","MbColor":"","MbText":"","MbPattern":"","main_font":"13px","font_h1":"44px","font_h2":"33px","font_h3":"24px","go_respo":"0","cache_time":"60","direction":"ltr","compress_css":"0","compress_js":"0","enable_ga":"0","ga_code":"","showcp":"1","copyright":"2016 olwebdesign. All Rights Reserved.","designed_by":"1","copanel":"Top Panel","showtop":"0","show_awesome":"1","ie6warn":"1","jquery":"0","bootstrap":"1","hide_component":"0","hide_menu_items":"0"}');

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_ucm_base`
--

CREATE TABLE IF NOT EXISTS `cz2qa_ucm_base` (
...
--
-- Table structure for table `cz2qa_ucm_content`
--

CREATE TABLE IF NOT EXISTS `cz2qa_ucm_content` (
...
--
-- Table structure for table `cz2qa_ucm_history`
--

CREATE TABLE IF NOT EXISTS `cz2qa_ucm_history` (
...
--
-- Table structure for table `cz2qa_updates`
--

CREATE TABLE IF NOT EXISTS `cz2qa_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Available Updates' AUTO_INCREMENT=74 ;

--
-- Dumping data for table `cz2qa_updates`
--

INSERT INTO `cz2qa_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(14, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
...
(17, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
...
--
-- Table structure for table `cz2qa_update_sites`
--

CREATE TABLE IF NOT EXISTS `cz2qa_update_sites` (
...
--
-- Dumping data for table `cz2qa_update_sites`
--

INSERT INTO `cz2qa_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1481826446, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1481826447, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1481826449, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1481826451, '');

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `cz2qa_update_sites_extensions` (
...
--
-- Dumping data for table `cz2qa_update_sites_extensions`
--

INSERT INTO `cz2qa_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28);
...
--
-- Table structure for table `cz2qa_usergroups`
--

CREATE TABLE IF NOT EXISTS `cz2qa_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `cz2qa_usergroups`
--

INSERT INTO `cz2qa_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `cz2qa_users`
--

CREATE TABLE IF NOT EXISTS `cz2qa_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `email` (`email`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=644 ;

--
-- Dumping data for table `cz2qa_users`
--

INSERT INTO `cz2qa_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(643, 'Super User', 'admin', 'mixas.8383@gmail.ru', '$2y$10$Kfu1xXP8ScaVSg1XMqcQSOZHaAVR1NZ4R8ZbDtDcAJwVzx1X9jvNa', 0, 1, '2016-12-15 18:26:20', '2016-12-15 18:27:18', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_user_keys`
--

CREATE TABLE IF NOT EXISTS `cz2qa_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `cz2qa_user_notes`
--

CREATE TABLE IF NOT EXISTS `cz2qa_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cz2qa_user_profiles`
--

CREATE TABLE IF NOT EXISTS `cz2qa_user_profiles` (
...
--
-- Table structure for table `cz2qa_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `cz2qa_user_usergroup_map` (
...
--
-- Dumping data for table `cz2qa_user_usergroup_map`
--

INSERT INTO `cz2qa_user_usergroup_map` (`user_id`, `group_id`) VALUES
(643, 8);

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `cz2qa_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `cz2qa_utf8_conversion`
--

INSERT INTO `cz2qa_utf8_conversion` (`converted`) VALUES
(1);

-- --------------------------------------------------------

--
-- Table structure for table `cz2qa_viewlevels`
--

CREATE TABLE IF NOT EXISTS `cz2qa_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `cz2qa_viewlevels`
--

INSERT INTO `cz2qa_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
